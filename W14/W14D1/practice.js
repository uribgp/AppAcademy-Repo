...
const header = React.createElement('div', { className: 'post-header' },
...
const postFooter = React.createElement('div', { className: 'post-footer' },
...
const nav = React.createElement('nav', null, 
    ...
    React.createElement('li', null,
        ...
        React.createElement('ul', { className: 'right-nav'}, 
            React.createElement('li'), null,
...
const tweetForm = () => React.createElement('form', {className: 'tweet-form'},
...
const tweetList = (props) => { return React.createElement('ul', {className: 'tweets-list'},
...
const tweet = ({body, user }) => React.createElement('li', {className: 'tweet-body'},
    ...
    const everything = React.createElement('section', { className: 'tweets'},
        React.createElement(form, null),
        React.createElement(tweetsList, {tweets: [
